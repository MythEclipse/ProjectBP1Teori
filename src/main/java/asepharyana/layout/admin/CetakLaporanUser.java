...
public class CetakLaporanUser {
    ...
    public void generateReport(List<Map<String, ?>> data, String outputFilePath) {
        try {
            ...
            // Add Fields
            String[] fields = { "id", "username", "password", "jenisKelamin", "alamat" };
            ...
            String[] headers = { "ID", "Username", "Password", "Jenis Kelamin", "Alamat" };
    ...
    List<Map<String, ?>> fetchData() {
        ...
        String sql = "SELECT id, username, password, jenisKelamin, alamat FROM User";
